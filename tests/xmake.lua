...
test_proj("test_native_incremental_lexer", "unit/native/test_incremental_lexer.cpp", function()
  ...
  test_proj("test_native_prune_history", "unit/native/test_prune_history.cpp", function()
      add_deps("runtime_py")
  end)
  ...
  -- unit/native (kimix runtime workspace kernels - plan 020)
  test_proj("test_native_workspace", "unit/native/test_workspace.cpp", function()
      add_deps("runtime_py")
  end)

  -- unit/native (kimix runtime todo kernels - plan 021)
  test_proj("test_native_todo", "unit/native/test_todo.cpp", function()
      add_deps("runtime_py")
  end)

  -- unit/native (kimix runtime image kernels - plan 022)
  test_proj("test_native_image", "unit/native/test_image.cpp", function()
      add_deps("runtime_py")
  end)
